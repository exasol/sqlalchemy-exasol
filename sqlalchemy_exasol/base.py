...
RESERVED_WORDS = {
    ...
    'goto', 'grant', 'granted', 'group', 'group_concat', 'grouping', 'having', 'high',
    'hold', 'hour', 'identity', 'if', 'ifnull', 'immediate', 'implementation', 'import',
    'in', 'index', 'indicator', 'inner', 'inout', 'input', 'insensitive', 'insert',
    'instance', 'instantiable', 'int', 'integer', 'integrity', 'intersect', 'interval',
    'into', 'inverse', 'invoker', 'is', 'iterate', 'join', 'key_member', 'key_type',
    'large', 'last', 'lateral', 'ldap', 'leading', 'leave', 'left', 'level', 'like',
    'limit', 'local', 'localtime', 'localtimestamp', 'locator', 'log', 'longvarchar',
    'loop', 'low', 'map', 'match', 'matched', 'merge', 'method', 'minus', 'minute',
    'mod', 'modifies', 'modify', 'module', 'month', 'names', 'national', 'natural',
    'nchar', 'nclob', 'new', 'next', 'nls_date_format', 'nls_date_language',
    'nls_first_day_of_week', 'nls_numeric_characters', 'nls_timestamp_format', 'no',
    'nocycle', 'nologging', 'none', 'not', 'null', 'nullif', 'number', 'numeric',
    'nvarchar', 'nvarchar2', 'object', 'of', 'off', 'old', 'on', 'only', 'open',
    'option', 'options', 'or', 'order', 'ordering', 'ordinality', 'others', 'out',
    'outer', 'output', 'over', 'overlaps', 'overlay', 'overriding', 'pad',

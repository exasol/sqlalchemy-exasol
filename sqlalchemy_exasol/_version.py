...
def get_expanded_variables(versionfile_abs): # pragma: no cover
...
def versions_from_expanded_variables(variables, tag_prefix, verbose=False): # pragma: no cover
...
def versions_from_vcs(tag_prefix, root, verbose=False): # pragma: no cover  
...
versionfile_source = "sqlalchemy_exasol/_version.py"

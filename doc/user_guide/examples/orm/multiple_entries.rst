...
rely upon auto-incrementation of the IDs. In particular, note that in ``1.a`` and ``1.b``
...
.. literalinclude:: ../../../../examples/features/orm/_2_working_with_multiple_entries.py
       :language: python3
       :caption: examples/features/orm/_2_working_with_multiple_entries.py
